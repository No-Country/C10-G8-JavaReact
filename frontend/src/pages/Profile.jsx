            ...
            <div className='w-screen h-[80vh] bg-[white] px-16 py-8 ' >
               <div className='bg-[white] w-full h-full rounded-3xl p-12 flex flex-row ' >
                       ...
                       <div className="flex flex-col space-y-1 p-6"> 
                           <h1 className="px-5 text-[#202F59] text-3xl font-bold body-font font-poppins not-italic"></h1>
                           <h2 className="px-5 text-xl text-[#5333ED4D] body-font font-poppins italic"> </h2>
