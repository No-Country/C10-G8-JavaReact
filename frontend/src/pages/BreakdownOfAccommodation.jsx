...
const BreakdownOfAccommodation = () => {
    ...
    return (
        <main className='container w-full h-full bg-[#03052e] flex-col gap-10 p-5 text-white'>
            ...
            <footer className='flex w-full text-black justify-around bg-gray-400'>
                <div className='flex flex-col'>
                    <h2>G&&S</h2>
                    <ul >
                        <li>Home</li>
                ...
                <div className='flex flex-col'>
                    <h2>Suscríbase al <br />
                        newsletter</h2>
                    <p>Suscríbase y entérese de nuevos hospedajes y descuento. Escriba su mail.</p>
                    <div>
                        <input type="text" />
