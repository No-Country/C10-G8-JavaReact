                 ...
                 <div className="flex flex-col space-y-1 p-6"> 
                     ...
                     <br></br>   
                       ...
                       <div className="p-2 flex"> 
                         ...
                         <h2 className=" p-0 text-[#202F59] font-bold body-font font-poppins not-italic text-xl underline underline-offset-8">Información</h2>
                              
                       </div>
                       <div className="flex-col py-2 p-14"> 
                                      <h4 className="p-0 text-[#202F59] body-font font-poppins not-italic text-xl">Información</h4>
                                      <textarea
                                      className="w-full rounded-lg border-1 bg-[white] 
                                      py-[0.92rem] px-32 leading-[1.9]
                                       outline-none transition-all
                                       duration-200 ease-linear"></textarea>
                                   </div>
                                   <div className="flex-col py-2 p-14"> 
                                      <h4 className="p-0 text-[#202F59] body-font font-poppins not-italic text-xl">Ubicación</h4>
                                      <textarea
                                      className="w-full rounded-lg border-1 bg-[white] 
